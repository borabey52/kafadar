...
st.markdown("""
    ...
    .block-container {
        ...
        padding-bottom: 250px; /* Alt kısımda rahat hareket alanı */
    }
    ...
    /* --- MİKROFON AYARI (ÇAKIŞMAYI ÖNLEME) --- */
    [data-testid="stAudioInput"] {
        position: fixed;
        bottom: 110px; /* Yazı kutusunun iyice üzerine taşıdık */
        left: 0;
        right: 0;
        ...
        max-width: 700px;
        z-index: 999;
        background-color: rgba(252, 253, 253, 0.95); /* Arka planı biraz daha matlaştırdık */
        padding: 10px 20px;
...
# Syntax hatası olmaması için try bloğu dışında, düz akışta yazıyoruz.
